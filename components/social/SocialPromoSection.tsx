  ...
  return (
    <section className="relative z-10 bg-charcoal/45 py-24 backdrop-blur-sm">
      <div className="mx-auto max-w-[900px] px-5 sm:px-8">
        <SectionHeading kicker={s.kicker} title={s.title} align="center" subtitle={s.subtitle} />
        <motion.div
        ...
        >
          {s.body ? (
            <p className="text-lg font-medium text-cream">{s.body}</p>
          ) : null}
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              ...
              <span>
                ...
                <span className="text-cream/70">({s.instagramHandle ?? SOCIAL_LINKS.instagram.handle})</span>
              </span>
            </a>
            <a
